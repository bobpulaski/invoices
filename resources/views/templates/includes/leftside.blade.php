<ul class="flex flex-col">
    ...
    <li>
        <a class="uppercase {{ request()->routeIs('companies.index') ? 'bg-gray-600' : '' }} flex h-16 p-3 text-gray-300 justify-start items-center align-middle hover:bg-gray-600" href={{ route('companies.index') }}>
    ...
    <li>
        <a class="uppercase {{ request()->routeIs('invoices.index') ? 'bg-gray-600' : '' }} flex h-16 p-3 text-gray-300 justify-start items-center align-middle hover:bg-gray-600" href={{ route('invoices.index') }}>
            <svg xmlns="http://www.w3.org/2000/svg" class="text-gray-300 mr-3 h-6 w-6 align-middle" fill="none" viewBox="0 0 24 24" stroke="currentColor">
